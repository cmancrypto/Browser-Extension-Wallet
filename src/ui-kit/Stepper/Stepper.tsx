          ...
          {steps.map((_, index) => (
            ...
            >
              ...
              >
                <span
                  className={cn(
                    'w-[34px] h-[34px] bg-neutral-2 rounded-full flex justify-center items-center text-large/[28px] text-white',
                ...
                <p className={cn('mt-2 text-small text-nowrap')}>{labels[index]}</p>
              </div>
            </li>
          ))}
        </ol>
